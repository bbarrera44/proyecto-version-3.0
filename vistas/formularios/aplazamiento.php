<div class="form-area" style="height: 1100px; top:70%;">
  ...
  <br />
<br />
<form action="../controladores/aplazamiento_.php" method="post">
          ...
          <select name="tipo_documento">
            ...
            <p>Numero de Documento</p>
              <input type="text" name="documento" placeholder="Numero de documento" required>
                <p>Fecha Solicitud</p>
              <input type="text" name="" placeholder="AAAAMMDD" value="<?php echo date("d-M-Y");?>" required><input type="hidden" name="fecha_aplazamiento" placeholder="AAAAMMDD" value="<?php echo date("Ymd");?>" required>
            <p>Motivo Solicitud</p>
          <br />
        <textarea name="solicitud" placeholder="Describe el motivo" required></textarea>
      <p>Descripcion</p>
        <br />
