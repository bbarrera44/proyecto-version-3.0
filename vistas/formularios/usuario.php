...
<div class="container">
		...
		<?php if ($reg['id_cargo']==1): ?>
			<input type="button" value="Actualizar informacion Usuario" class="btn btn-primary btn-lg btn-block" style="border-radius: 12px;" data-toggle="modal" data-target="#modalac" data-whatever="@mdo"/>
		<?php endif; ?>
...
<br>
	<?php } ?>
	<!-- Modal -->
	<div class="modal fade" id="modalac" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="modalac">Acualizar informacion:</h5>
				...
				<div class="modal-body">
					<form action="../controladores/controlar.php?n=mod_us_aparte" method="post">
						<div class="form-group">
							<label for="recipient-name" class="col-form-label">Al ser administrador puede cambiarlos datos de otro usuario.</label>
						</div>
						<div class="form-group">
							<label for="message-text" class="col-form-label">Dijite el numero del documento</label>
							<input type="text" class="form-control" id="recipient-name" name="documento" style="background-color: #DEE4E4;">
						</div>
					</div>
